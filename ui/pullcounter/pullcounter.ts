...
const bossFightTriggers: readonly Boss[] = [
  {
    ...
    startRegex: {
      ...
      tc: NetRegexes.gameLog({ line: '.*恭敬地對木人行禮.*?' }),
  ...
  },
  {
    ...
    startRegex: {
      ...
      tc: NetRegexes.ability({ source: '艾克斯迪司', id: '23F4' }),
  ...
  },
  {
    ...
    startRegex: {
      ...
      tc: NetRegexes.ability({ source: '新生艾克斯迪司', id: '2417' }),
  ...
  },
  {
    ...
    startRegex: {
      ...
      tc: NetRegexes.startsUsing({ source: '凱夫卡', id: '28C2' }),
  ...
  },
  {
    ...
    startRegex: {
      ...
      tc: NetRegexes.startsUsing({ source: '凱夫卡', id: '28EC' }),
  ...
  },
  {
    ...
    startRegex: {
      ...
      tc: NetRegexes.ability({ source: '歐米茄M', id: '337D' }),
  ...
  },
  {
    ...
    startRegex: {
      ...
      tc: NetRegexes.ability({ source: '歐米茄', id: '336C' }),
